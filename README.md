...
- Multi-parameter sensing: soil moisture, gas concentration, temperature, humidity, light intensity
- Local real-time visualization via **OLED display**
- Remote monitoring via the **Blynk IoT** mobile dashboard
...
![Soil Node Circuit](images/fig1_soil_node_circuit.png)

![Gas Node Circuit](images/fig2_gas_node_circuit.png)

![Environment Node Circuit](images/fig3_environment_node_circuit.jpg)

![Block Diagram](images/fig4_block_diagram.jpg)

![Environment Node](images/fig5_environment_node_photo.jpg)

![Blynk Dashboard](images/fig6_blynk_dashboard_1.jpg)
